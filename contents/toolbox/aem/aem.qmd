# i. Analytic Element Method Transport Model and Complex Source Designer {.unnumbered}
...
@fig-6-i-01 identifies the main areas used to configure the model and construct
the source zone.

![AEM Source Designer overview showing the simulation settings, source canvas, JSON import control, and simulation control.](images/aem/fig6-i-01.png){#fig-6-i-01 fig-align=center width=90%}
...
4. Choose the required element type as shown in @fig-6-i-02. The available
   tools are **Polygon (1)**, **Circle (2)**, **Ellipse (3)**, **Line (4)**, and
   **Select (5)**.

![Selecting a source-element type in the AEM Source Designer.](images/aem/fig6-i-02.png){#fig-6-i-02 fig-align=center width=60%}

5. To create a polygonal source zone, select **Polygon (1)** and place its
   vertices on the source pane as shown in @fig-6-i-03.

![Placing a polygonal source-zone boundary on the source pane.](images/aem/fig6-i-03.png){#fig-6-i-03 fig-align=center width=90%}

6. Select **Close & Pack polygon** to fill the polygon with circular source
   elements as shown in @fig-6-i-04.

![Filling a polygon with circular source elements.](images/aem/fig6-i-04.png){#fig-6-i-04 fig-align=center width=90%}
...
7. Add further source elements if required. Use **Select (5)** to choose an
   ...
   **Run Simulation** as shown in @fig-6-i-05.

![Adding further source elements or running the configured simulation.](images/aem/fig6-i-05.png){#fig-6-i-05 fig-align=center width=90%}

8. Select **Export (s)** to save the current model configuration as JSON. The
   import and export controls are highlighted in @fig-6-i-06.

![Importing a model configuration from JSON or exporting the current configuration to JSON.](images/aem/fig6-i-06.png){#fig-6-i-06 fig-align=center width=60%}
