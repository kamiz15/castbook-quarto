# i. Model Selection Method {.unnumbered}

**The Model Selection toolbox is not implemented in the PACS yet**. 
...
PACS provides several models of different types (analytical, numerical and empirical/hybrid). 
...
![Flow-chart on approach for selecting site-specific decision model.](images/model-selection/fig7-i-01.png){#fig-7-i-01 fig-align="center" width="80%"}

The flow-chart provided above can be fully automated. Furthermore, it can be linked with data toolbox of PACS.