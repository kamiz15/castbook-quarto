...
Clicking the **Empirical Toolbox** box in the homepage (@fig-birla2020_0) will lead to the interface that lists  all the empirical models available in the CAST. To use the Birla et al. (2020) model from the interface shown in the screenshot below, please click on the option **`Click here to see the model`** below the Birla et al. (2020) as shown on the  screenshot below.
