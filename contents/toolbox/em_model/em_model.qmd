...
1. [Maier and Grathwohl (2006)](mg2006.qmd) 

    $$
 L_{max} = 0.5\frac{M^2}{\alpha_{TV}}\bigg(\frac{\gamma C_{ED}}{C_{EA}}\bigg)^{0.3} 
  $$
2. [Birla et al. (2020) ](birla2020.qmd)
...
The empirical model interface of CAST can be accessed from the CAST [homepage](www.cast.iitd.ac.in). [Registration/Login](../../online/login.qmd) information are required for using empirical models. 

![Accessing Empirical models toolbox in CAST](images/empirical-model-toolbox/fig4-01.png){#fig-4-01 fig-align="center" width="60%"}
...
Details on these interfaces, which is identical to the interface for _analytical models_ are provided [here](../an_model/an_model.qmd). The screenshot provides the CAST interface to select a empirical model.

![Selecting an empirical model](images/empirical-model-toolbox/fig4-02.png){#fig-4-02 fig-align="center" width="60%"}