...
![Birla et al. (2020)- conceptual set-up](images/birla2020_f1.png){#fig-birla2020_f1 fig-align="center" width="60%"}
...
Clicking the **Empirical Toolbox** box in the homepage (@fig-birla_f1a) will lead to the interface that lists all the empirical models available in the CAST. To use the Birla et al. (2020) model from the interface shown in the screenshot below, please click on the option ``Click here to see the model`` below the Birla et al. (2020) as shown on the screenshot below.

![Selecting an empirical model](images/birla2020_f1a.png){#fig-birla_f1a fig-align="center" width="60%"}
...
![Parameters required in Birla et al. (2020) model](images/birla2020_f2.png){#fig-birla_f2 fig-align="center" width="50%"}
...
![Selecting site to compare using multiple computing interface of CAST](images/birla2020_f3.png){#fig-birla_f3 fig-align="center" width="60%"}
...
![Available options for extracting model results from CAST interface.](images/birla2020_f4.png){#fig-birla_f4 fig-align="center" width="60%"}
