...
The code snippet below shows the implementation of **flow** simulation in CAST. Complete source-code is accessible from [here](https://github.com/kamiz15/Groundwater-Contamination-Website/blob/main/numerical_models.py).
...
@fig-5-i-02 provides the screenshot of system parameters input interface of the CAST.
...
@fig-5-i-03 provides the screenshot of hydraulic and chemical parameters input interface of the CAST.
...
@fig-5-i-04 provides the screenshot of the model output from CAST.
