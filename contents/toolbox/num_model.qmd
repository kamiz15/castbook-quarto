...
![Numerical model conceptual set-up](images/num_f1.png){#fig-num1 fig-align="center" width="60%"}
...
@fig-num2 provides the screenshot of system parameters input interface of the CAST.

![Numerical model system parameters](images/num_f2.png){#fig-num2 fig-align="center" width="40%"}
...
@fig-num3 provides the screenshot of hydraulic and chemical parameters input interface of the CAST.

![Numerical model hydraulic and chemical parameters](images/num_f3.png){#fig-num3 fig-align="center" width="40%"}
...
@fig-num4 provides the screenshot of the model output from CAST.

The obtained output can be saved as a *.png* file.


![Numerical model output](images/num_f4.png){#fig-num4 fig-align="center" width="70%"}
