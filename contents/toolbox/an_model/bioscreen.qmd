...
The BIOSCREEN-AT, provided in [Karanovic et al. (2007)](#refbs) Model provides an exact analytical Solution to the BIOSCREEN Model. The model provides a three-dimensional solution for transport of dissolved contaminants, incorporating natural attenuation processes. As shown in @fig-bscreen_f1 , the source is given as a patch specified-concentration boundary condition.

![The BIOSCREEN-AT model concept](images/bscreen/bscreen_f1.png){#fig-bscreen_f1 fig-align="center" width="70%"}
...
First all input data needs to be defined (screenshot @fig-bscreen_f2). Then a graph is genereated, that shows the result of the computation in comparison to the field data from the CAST database (screenshot @fig-bscreen_f3).

![The CAST interface for BIOSCREEN-AT data input](images/bscreen/bscreen_f2.png){#fig-bscreen_f2 fig-align="center" width="70%"}

![The CAST interface for BIOSCREEN-AT output](images/bscreen/bscreen_f3.png){#fig-bscreen_f3 fig-align="center" width="50%"}

Once the first computation of $L_{max}$ pressing `Generate graph` button is made, the CAST interface provides interface with **sliders** bars (@fig-bscreen_f4) for the most sensible model parameters.

![Interactive sliders in CAST for BIOSCREEN-AT model](images/bscreen_f4.png){#fig-bscreen_f4 fig-align="center" width="50%"}
...
![Multiple computing interface in CAST for BIOSCREEN-AT model](images/bscreen/bscreen_f5.png){#fig-bscreen_f5 fig-align="center" width="50%"}
