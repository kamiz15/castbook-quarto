...
Clicking the **Analytical Toolbox** box in the homepage will lead to the interface that lists (@fig-fig3.1-ii) all the analytical models available in the CAST. To use the @liedl2005 model. From that interface, please click on the option **`about`** in the  **Liedl et al (2005)** as shown on the  screenshot (@fig-fig3.1-ii).
...
![](images/liedl2005/fig3.1-xi.png "Liedl2005 - Providing multiple scenarios data to the CAST interface"){
width="80%" 
height="350px" 
fig-align="center" 
fig-alt="Screenshot of liedl2005 - Providing multiple scenarios data to the CAST interface"}

@liedl2005: Providing multiple scenarios data to the CAST interface
...
![](images/liedl2005/fig3.1-xiii.png "Liedl2005 - Manually adding scenario data to CAST"){
width="80%" 
height="350px" 
fig-align="center" 
fig-alt="Screenshot of liedl2005 - Manually adding scenario data to CAST"}

@liedl2005: Manually adding scenario data to CAST
