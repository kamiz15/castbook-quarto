...
![The quick way to use the **single computing interface** in CAST](images/on3.png){#fig-quickeg1 fig-align="center" width="70%"}
...
![The quick way to use the **multiple computing interface** in CAST](images/on4.png){#fig-quickeg2 fig-align="center" width="70%"}
...
Numerical model in CAST is based of MODFLOW/MT3DMS. Complete detail of the model is provided [here](../../contents/toolbox/num_model.qmd)
...
![The quick way to use the **Numerical computing interface** in CAST](images/on5.png){#fig-quickeg3 fig-align="center" width="50%"}