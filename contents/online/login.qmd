...
@fig-on1 provides the _user_ registration and _login_ interface of the CAST.


![Registration and login interface of online CAST](images/on1.png){#fig-on1 fig-align="center" width="40%"}
...
![Online registration code used in CAST](images/on2.png){#fig-on2 fig-align="center" width="50%"}

@fig-on2 above shows the registration code used in CAST, there are no cross verification of user information as can been seen in the code. Also, user passwords is encrypted before storing.