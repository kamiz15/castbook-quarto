...
![The offline use of CAST](images/off_f26.png){#fig-qoff1 fig-align="center" width="40%"}


The usage of offline CAST is exactly identical to that for the online use. User can follow the quick details provide [here](../../contents/online/quick_example.qmd). Complete details on using models are provided in models pages.