...
![The [Flask](https://palletsprojects.com/p/flask/) framework of CAST](images/code-libraries/fig8-ii-01.png){#fig-8-ii-01 fig-align="center" width="60%"}

@fig-8-ii-01 above shows how the Flask framework functions
...
![Code snapshot showing usage of Python libraries in CAST](images/code-libraries/fig8-ii-02.png){#fig-8-ii-02 fig-align="center" width="60%"}

@fig-8-ii-02 above is a snapshot of a code from CAST displaying various Python libraries like _Numpy_, _SciPy_, _Matplotlib,_ and _Plotly_ . This code is helping to make a scatterplot visualisation with fits (linear, exponential etc)
...
![FloPy code used in CAST](images/code-libraries/fig8-ii-03.png){#fig-8-ii-03 fig-align="center" width="60%"}

@fig-8-ii-03 above is a snapshot of a code from CAST displaying how FloPy is being used for the numerical model
...
![MySQL use in CAST](images/code-libraries/fig8-ii-04.png){#fig-8-ii-04 fig-align="center" width="60%"}

@fig-8-ii-04 above is a snapshot of a code from CAST displaying the tables/relational mappings for MySQL
