...
![The [Flask](https://palletsprojects.com/p/flask/) framework of CAST](images/CS_f3.png){#fig-cs3 fig-align="center" width="60%"}

@fig-cs3 above shows how the Flask framework functions
...
![Code snapshot showing usage of Python libraries in CAST](images/CS_f4.png){#fig-cs4 fig-align="center" width="60%"}

@fig-cs4 above is a snapshot of a code from CAST displaying various Python libraries like _Numpy_, _SciPy_, _Matplotlib,_ and _Plotly_ . This code is helping to make a scatterplot visualisation with fits (linear, exponential etc)
...
![FloPy code used in CAST](images/CS_f5.png){#fig-cs5 fig-align="center" width="60%"}

@fig-cs5 above is a snapshot of a code from CAST displaying how FloPy is being used for the numerical model
...
![MySQL use in CAST](images/CS_f6.png){#fig-cs6 fig-align="center" width="60%"}

@fig-cs6 above is a snapshot of a code from CAST displaying the tables/relational mappings for MySQL
