...
![The main code structure of CAST](images/CS_f1.png){#fig-cs1 fig-align="center" width="60%"}
...
@fig-cs1 shows the screenshot of the main code structure of CAST.
...
![The main code structure of CAST](images/CS_f2.png){#fig-cs2 fig-align="center" width="60%"}


Other files include python files consisting of routes, initialisation and integration codes for CAST.
@fig-cs2 shows the screenshot of the code structure of the `groundwater` folder of the CAST.
